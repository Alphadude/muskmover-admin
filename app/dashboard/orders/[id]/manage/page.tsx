          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-10 gap-x-12">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-[#EA580C] shrink-0 shadow-sm">
                  <ShieldCheck size={24} />
                </div>
                <div>
                   <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 mb-1">Target</p>
                   <p className="text-lg font-bold text-slate-900 leading-tight">{order.orderNumber}</p>
                </div>
              </div>
              
              <div className="space-y-1 flex flex-col justify-center border-l border-slate-100 pl-8">
              ...
              <div className="space-y-1 flex flex-col justify-center border-l border-slate-100 pl-8">
                ...
                <p className="text-xs font-semibold text-emerald-600">{order.crewRequested ? 'Includes Crew' : 'Equipment Only'}</p>
              </div>

              <div className="space-y-1 flex flex-col justify-center border-l border-slate-100 pl-8">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Total Value</p>
                <p className="text-xl font-black text-[#EA580C]">₦{(order.totalPrice || 0).toLocaleString()}</p>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Select value={status} onValueChange={setStatus}>
                  <SelectTrigger className="w-full h-12 rounded-xl border-slate-200 focus:ring-[#EA580C] focus:border-[#EA580C] bg-white">
